        ...
        <footer>
            ...
            <details className="footer-details">
                ...
                <details>
                    ...
                    <br></br><br></br>
                    The Web App deletes its cache every time is visited as well as every 15 minutes whilst the Web App is open. The session storage is cleared once the data is consumed by the Web App or when the page session ends (A page session lasts as long as the tab or the browser is open, and survives over page reloads and restores). The local storage has no expiration time, however, it can be cleared by the User manually, the way of cleaning this data depends on the browser but usually it’s done by clearing the browser data and/or cookies.
                </details>
                <details>
